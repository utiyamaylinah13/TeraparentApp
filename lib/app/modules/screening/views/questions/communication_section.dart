...
class CommunicationSection extends GetView<ScreeningController> {
  const CommunicationSection({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  const Expanded(
                    child: Text(
                      "Apakah anak dapat mengucapkan setidaknya 3 kata bermakna?",
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w600,
                        color: Color(0xFF1E293B),
        ...
        const TipsCard(
          text:
              "Lakukan observasi santai saat anak bermain untuk hasil yang lebih akurat.",
        ),
